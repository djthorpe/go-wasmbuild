...
func Example_Form_001() (mvc.View, string) {
	return bs.Form("form_001", bs.Card(
		bs.Input("username", bs.WithPlaceholder("Username or Email Address"), mvc.WithClass("mb-3")),
		bs.SecureInput("password", bs.WithPlaceholder("Password"), mvc.WithClass("mb-3")),
	).Footer(
