...
const (
	...
	EventTagBeingClosed              = "cds-tag-beingclosed"
	EventTagClosed                   = "cds-tag-closed"
	EventTagDismissibleBeingClosed   = "cds-dismissible-tag-beingclosed"
	EventTagDismissibleClosed        = "cds-dismissible-tag-closed"
	EventTagOperationalBeingSelected = "cds-operational-tag-beingselected"
...
var EventName = map[string]string{
	...
	EventTagBeingClosed:              "EventTagBeingClosed",
	EventTagClosed:                   "EventTagClosed",
	EventTagDismissibleBeingClosed:   "EventTagDismissibleBeingClosed",
	EventTagDismissibleClosed:        "EventTagDismissibleClosed",
	EventTagOperationalBeingSelected: "EventTagOperationalBeingSelected",
